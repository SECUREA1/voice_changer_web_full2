...
erc20_contract_eth = eth_web3.eth.contract(address=Web3.to_checksum_address(ETH_token_address), abi=ERC20_ABI)
erc20_contract_bsc = bsc_web3.eth.contract(address=Web3.to_checksum_address(BSC_token_address), abi=ERC20_ABI)
